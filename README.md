...
| **Module 1** | [Intro to Angular](angular-intro.md) Adam| [Angular Routing](angular-routing.md) Adam | [ngResource](angular-resource.md) Juliana | Review Briana/Cameron | Weekend Project |
